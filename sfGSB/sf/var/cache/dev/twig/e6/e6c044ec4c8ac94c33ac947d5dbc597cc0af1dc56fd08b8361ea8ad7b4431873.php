...
class __TwigTemplate_832eb2361914389540bd188b2e9f06ffa531c98ac8c242d6c3a7c72b0598ba1a extends Template
{
    ...
    <div class=\"btns\">
        ...
        // line 15
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 15, $this->source); })()), "Créer l'état")) : ("Créer l'état")), "html", null, true);
        echo "</button>            
          </div>
...
";
    ...
    <div class=\"btns\">
            <button class=\"btn-menu animated fadeInUp scrollto\" style=\"background-color: transparent;\">{{ button_label|default('Créer l\\'état') }}</button>            
          </div>
